...
<!-- Fonts and icons -->
<script src="{{ asset('kaiadmin_lite/examples/demo1/assets/js/plugin/webfont/webfont.min.js') }}"></script>
<script>
    WebFont.load({
        google: {
        ...
        custom: {
            ...
            urls: ["{{ asset('kaiadmin_lite/examples/demo1/assets/css/fonts.min.css') }}"]
        },
        active: function() {
